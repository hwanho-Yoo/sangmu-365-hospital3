        ...
        <Container narrow>
          <div className="max-w-[720px] mx-auto">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[15px] font-bold text-text-main">대중교통</p>
                <p className="text-[15px] text-text-body mt-1">상무지구 정류장 하차 후 도보 5분</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 mt-6">
              ...
              <div>
                <p className="text-[15px] font-bold text-text-main">자가용</p>
      ...
      <section className="py-8 md:py-10">
        <Container narrow>
          <div className="border border-border-light rounded-xl p-6 max-w-[560px] mx-auto">
            ...
            <p className="text-base font-bold text-text-main mt-3">{HOSPITAL.parking.name} (전용주차장)</p>
            <p className="text-[15px] text-text-body">{HOSPITAL.parking.address}</p>
            <p className="text-[15px] text-text-muted">{HOSPITAL.parking.note}</p>
          ...
          <div className="max-w-[480px] mx-auto">
            ...
            <div className="divide-y divide-dashed divide-border-light">
              <div className="flex justify-between items-center py-3">
                <span className="text-base text-text-body">평일</span>
                <div className="flex items-center gap-2">
                  <span className="text-base font-medium">{HOSPITAL.hours.weekday}</span>
                  <span className="text-[11px] bg-primary-light text-primary px-1.5 py-0.5 rounded-full">야간진료</span>
                </div>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-base text-text-body">토요일</span>
                <span className="text-base font-medium">{HOSPITAL.hours.weekend}</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-base text-text-body">일요일·공휴일</span>
                <span className="text-base font-medium">{HOSPITAL.hours.holiday}</span>
              </div>
              <div className="flex justify-between items-center py-3">
                <span className="text-base text-text-body">점심시간</span>
                <span className="text-base font-medium text-success">없음 (연속진료)</span>
              </div>
            </div>

            <p className="text-[15px] text-text-muted mt-4">
